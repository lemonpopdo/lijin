...
const onConfirmAdd = async () => {
  ...
  // 将新数据添加到数组开头，实现倒序显示
  batchList.value.unshift({ ...currentItem.value, date: currentItem.value.date || batchDate.value })
  // 重置表单
  currentItem.value = { bookId: bookId.value, money: defaultMoney.value, attendance: 0, date: batchDate.value }
